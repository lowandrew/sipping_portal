"""
Base settings for Sipping Portal project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (sipping_portal/config/settings/base.py - 3 = sipping_portal/)
APPS_DIR = ROOT_DIR.path('sipping_portal')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'sipping_portal.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///sipping_portal'),
}
...
SOCIALACCOUNT_ADAPTER = 'sipping_portal.users.adapters.SocialAccountAdapter'
